      ...
      <div class="card">
        <div class="card-header">
          <div class="card-tools">
            <template v-if="listRolPermisosByUsuario.includes('documentos.crear')">
               <router-link class="btn btn-info bnt-sm" :to="{name: 'documentos.crear'}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" v-model="fillBsqAlumno.cApellido" @keyup.enter="getListarAlumnos">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class ="table table-hover table-head-fixed text-nowrap projects">
                    ...
                    <tbody>
                      <tr v-for="(item, index) in listarAlumnosPaginated" :key="index">
                        ...
                        <td v-text="item.estado_fit"></td>
                        <td v-text="item.estado_tesis"></td>
                        <td>
                          <router-link class="btn btn-flat btn-primary btn-sm" :to="{name:'usuarios.ver', params:{id_user: item.id_user}}">
                            <i class="fas fa-folder"></i> Ver
                          </router-link>
                          <button class="btn btn-flat btn-success btn-sm" @click.prevent="setGenerarDocumento(item.id_tesis)">
                              <i class="fas fa-file-download"></i> Fit
                            </button>
                            <button class="btn btn-flat btn-warning btn-sm" @click.prevent="setGenerarMemoRevision(item.id_tesis)">
...
export default {
  ...
  methods:{
    ...
    limpiarCriteriosBsq(){
      ...
      this.fillBsqAlumno.cApellido = '';
      this.fillBsqAlumno.nRut = '';
      this.fillBsqAlumno.cEstado_tesis = '';
    },
